...
class LoaderConnection:
    ...
    def __init__(self, address: list[str], port: int):
        ...
        self._connection: Connection = Connection(address, port, bytearray([END_SYMBOL1, END_SYMBOL2]))
    ...
    def command(self,
        ...
        if message_body[COMMAND_CODE_INDEX] != int(cmd_type):
            raise DeviceException(DeviceError.InvalidResponseDataType)
